...
import { loginReducer } from '../../state/reducers/auth';
import DriveContext, { DriveProvider } from '../../state/contexts/driveContext';
...
const Home = () => {
  ...
  const [address, dispatchAddress] = React.useReducer(driveReducer, initialDirections);
